...
function extrae_exif($imagen) {
    ...
    $datos['Resolución']                     = $exif['COMPUTED']['Width'] . 'x' . $exif['COMPUTED']['Height'];
    $datos['Modelo de cámara']          	 = $exif['IFD0']['Model'];
    $datos['Tiempo de exposición']     		 = $exif['EXIF']['ExposureTime'] . ' seg';
